...
// These subreddits are all related to cute animals
var subreddits = ['aww', 'floof', 'AnimalsBeingDerps', 'bears', 'StartledCats', 'tapirs', 'rarepuppers', 'seals', 'dogs', 'cats']

module.exports = {
    name: 'cute',
    description: 'Grab a cute image from reddit',
        ...
        https.get(options, function(resp) {
            ...
            resp.on('end', function() {
                ...
                try {
                    ...
                    message.channel.send('Woops, I dropped the cute picture. Try again.')
                }
            })
