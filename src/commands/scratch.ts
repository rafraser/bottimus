...
import { User, MessageReaction, GuildMember, MessageEmbed } from 'discord.js'
...
export default {
  ...
  async execute (client: Client, message: Message, args: string[]) {
    ...
    const confirmMsg = await message.channel.send('Scratch cards cost 250 coins: react to confirm')
    confirmMsg.react('✅')
    ...
    collector.on('collect', () => {
      ...
      generateScratchCard(client, confirmMsg, message.member)
