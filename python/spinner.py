...
def render_emblem(logo):
    ...
    draw.pieslice((left - 8, left - 8, left + insize + 8, left + insize + 8), 0, 360, (245, 246, 250))
...
def main(prizes, filename='./img/wheel.gif'):
    ...
    durations[0] = 1000
    durations[-1] = 2500
    frames[0].save(filename, format='GIF', append_images=frames[1:], save_all=True, duration=durations, loop=0)
